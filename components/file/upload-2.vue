...
<script>
  'use strict';
  import language from '@/assets/uploader/language.js';
  import mimes from '@/assets/uploader/mimes.js';
  import data2blob from '@/assets/uploader/data2blob.js';
  import effectRipple from '@/assets/uploader/effectRipple.js';
